...
export default async function PowderPage({
  ...
  return (
    <main className="bg-[#f5f6f0]">
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                <div className="rounded-3xl border border-emerald-100/80 bg-white/95 p-5 text-sm shadow-[0_12px_30px_-24px_rgba(15,23,42,0.7)]">
                  ...
                  <p className="mt-3 text-slate-700">
                    Designed for {product.category.toLowerCase()} routines.{" "}
                    {product.description}
                  </p>
                </div>
                <div className="rounded-3xl border border-emerald-100/80 bg-white/95 p-5 text-sm shadow-[0_12px_30px_-24px_rgba(15,23,42,0.7)]">
                  ...
                  <p className="mt-3 text-slate-700">{product.dosage}</p>
      ...
      <section className="bg-gradient-to-b from-white via-emerald-100/60 to-white py-16">
